...
local LANGUAGES = {
    en = {
        ...
        theme_preset = "Theme",
        tooltip_theme_cycle = "RMB to cycle preset",
    ...
    nl = {
        ...
        theme_preset = "Thema",
        tooltip_theme_cycle = "RMB: wissel preset",
    ...
    de = {
        ...
        theme_preset = "Thema",
        tooltip_theme_cycle = "RMB: Preset wechseln",
        ...
        help_reaper_logs_body = "Bei Fehlern speichert STEMwerk kleine Logs (stdout, ffmpeg, separation log) im selben Ordner. Nuetzlich fuer Debugging oder Support.",
        help_reaper_cleanup_title = "Aufraeumen",
        help_reaper_cleanup_body = "Option \"Temp-Dateien behalten\" unter Modell behaelt die Tempmappe fuer Troubleshooting. Standardmaessig raeumt STEMwerk temporaere Dateien nach einem erfolgreichen Lauf auf.",
